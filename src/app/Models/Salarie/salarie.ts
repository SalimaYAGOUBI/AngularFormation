...
export class Salarie {
    ...
    constructor( idSal: string, nom : string, prenom : string, email : string, cnss : string, adresse : string, tel : string, statue : string, genre : string,
        rib : number,nomBanque : number, cin : string, dateNaissance : Date, profile : string, cv : string, dateEmploi : Date, salaire : number,typeContrat : string,
        DureContart : number, Etat : string, role : string, service : Service, division : Division, salarieProjet : Array<SalarieProjet>){
            this.idSal = idSal;
            this.nom = nom;
            this.prenom = prenom;
            this.email = email;
